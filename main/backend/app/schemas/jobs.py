...
class GenerateJDRequest(BaseModel):
    ...
    expectations: Optional[str] = Field(None, description="What success looks like (auto-generated if not provided)", example="Build scalable features, mentor juniors, drive technical decisions")
    ...
    company_tone: Optional[str] = Field(None, description="Tone/style for the JD; accepts any text and will be normalized server-side")
