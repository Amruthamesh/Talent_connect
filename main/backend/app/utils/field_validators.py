...
class FieldValidator:
    ...
    def _get_error_message(cls, field_name: str, field_type: str, value: str) -> str:
        ...
        messages = {
            ...
            'date': f"'{value}' is not a valid date. Use format YYYY-MM-DD, DD/MM/YYYY, or DD-MM-YYYY.",
    ...
    def get_field_hint(cls, field_name: str) -> str:
        ...
        field_examples = {
            ...
            'confirmation_date': "Example: 01/06/2025",
        ...
        type_hints = {
            ...
            'date': "Example: 25/11/2024 or 2024-11-25 (DD/MM/YYYY or YYYY-MM-DD)",
